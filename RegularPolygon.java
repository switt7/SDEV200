...
public class RegularPolygon {
	...
	// Makes a regular polygon with default values //
	RegularPolygon() {
		n = 3;
		side = 1;
		x = y = 0;
	...
	// Makes a regular polygon with the specified number 
