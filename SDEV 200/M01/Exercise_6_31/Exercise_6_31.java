...
public class Exercise_6_31 {
	...
	public static void main(String[] args) {
		try (Scanner input = new Scanner(System.in)) {
			// Ask the user to enter a credit card number as a long integer //
	...
	// Return the value true if the card number is one that is valid //
	public static boolean isValid(long number) {
		boolean valid =
	...
	// Return the value true if the digit d is a prefix for number //
	public static boolean prefixMatched(long number, int d) {
