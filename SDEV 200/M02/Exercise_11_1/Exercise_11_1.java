...
public class Exercise_11_1 {
	public static void main(String[] args) {
		try (//Generate a Scanner object
		Scanner input = new Scanner(System.in)) {
			//Tell the user to enter three sides of the triangle
			System.out.print("Enter three side of the triangle: ");
			double side1 = input.nextDouble();		
			double side2 = input.nextDouble();		
			double side3 = input.nextDouble();

			//Tell the user to enter a color
			System.out.print("Enter a color: ");
			String color = input.next();

			//Tell the user to enter whether the triangle is filled or not
			//by using true or false
			System.out.print("Is the triangle filled (true / false)? ");
			boolean filled = input.nextBoolean();

			//Generate triangle object with user input
